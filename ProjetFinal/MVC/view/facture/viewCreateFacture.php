			...
			<div class="container-fluid px-1 py-5 mx-auto">
				<div class="row d-flex justify-content-center">
					<div class="col-xl-7 col-lg-8 col-md-9 col-11 ">
						...
						<div class="card">
							<form action="index.php?controller=facture&action=created" method="POST" >
								<div class="form-group col-md-6">
									<label for="idant">identifiant de la facture</label>
									<input type="text" name="idf" class="form-control" id="idant" placeholder="S'il vous plait entrer l'identifiant de facture">
								  </div>
								<div class="info2">
								...
								<div class="form-group">
								  ...
								  <input type="text" name="paied" class="form-control" id="inputAddress" placeholder="S'il vous plait entrer le prix paié">
								  </div>
								  <div class="form-group col-md-6">
									<label for="date">Date d'emission</label>
									<input type="text" name="date_emis" class="form-control" id="date" placeholder=" aaaa-mm-jj">
								  </div>
								</div>
				            ...
				            <div class="order">
								<table>
									<tr>
									  ...
									  <td><input type="text" name="taxe"class="form-control" ></td>
									  <td><input type="text" name="Remise" class="form-control" ></td>
									  <td><input type="text" name="idcF" class="form-control" ></td>
									</tr>
								  </table>
                              </div>
			            </div>
